...
namespace QuantLib {
    ...
    /*! The log-price characteristic function of the rough Heston model
        ...
        Diethelm-Ford-Freed Adams predictor-corrector scheme or, much
        faster, with the Gatheral-Radoicic global rational (Padè)
        ...
        \note The fractional Adams scheme is the reference-quality but
              ...
              Padè approximation is an \f$ O(1) \f$ closed form matching the
              short- and long-time asymptotics of the Riccati solution that degrads 
              gracefully towards the classical Heston limit 
              \f$ H = \frac{1}{2} \f$.  Future pull requests will add lifted Heston 
    ...
    */
    class AnalyticRoughHestonEngine
      ...
      public:
        ...
        // solution h(z, t) of the fractional Riccati equation by the
        // configured route
        std::complex<Real> riccatiSolution(
      ...
      private:
        ...
        // approximation h(z, t) = N(y) / D(y) with y = sigma t^a, matching
        // the short-time series and the long-time root
        ...
        static std::complex<Real> evaluatePade(
